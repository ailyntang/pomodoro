  ...
  render() {
    ...
    return(
      <div className = 'set-duration'>
        <button id = {timerType + '-decrement'} onClick = {this.props.decrement.bind(this, timerType)}>-</button>
        <div id = {timerType + '-length'}>{this.props.duration}</div>
        <button id = {timerType + '-increment'} onClick = {this.props.increment.bind(this, timerType)}>+</button>
      </div>
    );
  }
}
...
class Controls extends React.Component {
  render() {
    ...
    return (
      <div id = 'controls'>
        <button id = 'start_stop' onClick = {this.props.toggleTimer}>
          <i className = {startStopIcon}></i>
        </button>
        
        <button id = 'reset' onClick = {this.props.reset}>
          <audio id='beep' src='https://ccrma.stanford.edu/~jos/mp3/JazzTrio.mp3'></audio>
  ...
  render() {
    ...
    return(
      <div id = 'pomodoro'>
        ...
        <div id = 'main-wrapper'>
          <div id = 'main-display'>
            <div id = 'time-left'>{convertToTimeFormat(this.state.timeLeft)}</div>

            <Controls isTimerRunning = {this.state.isTimerRunning} 
        ...
        <div id = 'set-durations'>
          <div id = 'session'>
            <div id = 'session-label'>work</div>
            <SetDuration timerType = 'session'
          ...
          <div id = 'break'>
            <div id = 'break-label'>play</div>
            <SetDuration timerType = 'break'
              increment = {this.increment} 
              decrement = {this.decrement}
